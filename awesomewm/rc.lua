...
mytextclock = wibox.widget.textclock("%a %d/%m/%y, %H:%M", 10)
...
clientkeys = gears.table.join(
  ...
  awful.key({ modkey, "Control" }, "z", awful.placement.centered,
    { description = "center floating window", group = "client" })

--awful.key({ modkey }, "Up", function () awful.util.spawn("xbacklight -dec 15") end,
--          {description = "aumenta luz", group = "client"}),
--awful.key({ modkey }, "Down", function () awful.util.spawn("xbacklight -dec 15") end,
--          {description = "diminui luz", group = "client"})
