...
let s:group_colors = {} " Cache of default highlight group settings, for later reference via `thenfeite#extend_highlight`
function! s:h(group, style, ...)
  if (a:0 > 0) " Will be true if we got here from thenfeite#extend_highlight
...
function! thenfeite#set_highlight(group, style)
  call s:h(a:group, a:style)
endfunction

function! thenfeite#extend_highlight(group, style)
...
let s:colors = thenfeite#GetColors()
...
call s:h("jsObjInUse", { "fg": s:red })
call s:h("jsPropInUse", { "fg": s:red })
call s:h("jsObjectProp", { "fg": s:red })
call s:h("jsClassKeyword", { "fg": s:purple })
call s:h("jsComment", { "fg": s:comment_grey })
...
call s:h("vimLineComment", { "fg": s:comment_grey })
call s:h("vimCommentTitle", { "fg": s:comment_grey, "gui": "bold", "cterm": "bold" })
